...
<div class="footer">
    <article id="wrap">
		<CardGrid>
			<img src="../assets/imgs/ads/logo.e102c5d9.png" alt="">
			<img src="../assets/imgs/ads/supercell-logo-white.ad1dad43.svg" alt="">
			<a href="https://www.instagram.com/ianluca_sw/">
				<img src="../assets/imgs/ads/team-ssoni.jpeg" alt="">
			</a>
		</CardGrid>
		<br>
        <div class="text-center text-white mt-5 p-5">
            <p>© 2025 Clan Info. All rights reserved.</p>
            <p class="mb-5">Developed by Federico Martinolich</p>
        </div>
